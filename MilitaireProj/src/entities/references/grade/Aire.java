...
public enum Aire {
    ...
    private static final List<Aire> listeGrade = new ArrayList<>();

    //CONSTRUCTOR
    Aire(String trigramme, String prefixOTAN, int indiceOTAN) {
    ...
    //GETTERS
    public static List<Aire> getListeGrade() {
        return Collections.unmodifiableList(listeGrade);
    }

    public static Aire getGrade(int index){
