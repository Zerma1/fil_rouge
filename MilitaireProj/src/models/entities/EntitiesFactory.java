...
public final class EntitiesFactory {
    ...
    public static Militaire creerTerrien(String nom, String prenom, Grade_AdT grade, Arme arme){
        return new Terrien(nom, prenom, grade, arme);
    }
    public static Militaire creerAviateur(String nom, String prenom, Grade_AAE grade, SpecialiteAAE specialite){
